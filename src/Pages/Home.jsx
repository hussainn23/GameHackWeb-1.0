...
// 
  ...
  return (
    ...
    >
        ...
        <div className='bg-[#2B0061] sm:min-h-[75vh]'>
           <div className=" grid grid-cols-3  md:w-[65%] sm:w-full lg:w-[60%] gap-3 m-auto lg:p-6 relative top-16 sm:p-1 ">
  ...
  {cardData.map((card, index) => (
    <div
      key={index}
      className={`lg:text-2xl ${card.bgGradient} cursor-pointer rounded-lg border-[1px] border-white p-4 text-white text-center text-xl font-semibold md:h-[150px] lg:h-[150px] md:flex lg:flex items-center justify-center`}
